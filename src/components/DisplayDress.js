...
const my_Data = [{img :  chiffon_dress ,  name : "chiffon dress" , details : " size : m    " ,  price : "1500" },
                { img :  fluffy_dress ,   name : "fluffy dress" ,  details : " size : xs    " ,  price : " 1400 "},
                {img :   High_neck_dress, name : "High neck dress", details : " size : s   " , price : "1600"},
                {img :   maria_dress ,     name :"maria dress" ,    details : " size : l    " , price : "1555"},
                {img :   midriff ,         name :'midriff' ,        details : " size : m   " ,  price : "1300"},
                {img :   One_shoulder_dresses, name :" One shoulder dresses", details : " size : m   " , price : "1800"},
                {img :   Puffed_sleeves ,      name :" Puffed sleeves" ,      details : " size : xl    " , price : "1500" },
                {img :   white_dantiel ,       name :" white dantiel dress" , details : "size : m    " , price : "1200" }]
