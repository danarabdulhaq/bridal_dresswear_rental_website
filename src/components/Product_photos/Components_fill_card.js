...
const my_Data = [{img :  chiffon_dress ,  name : "chiffon dress" , details : " " ,  price : "1500" },
                { img :  fluffy_dress ,   name : "fluffy dress" ,  details : " " ,  price : " 1400 "},
                {img :   High_neck_dress, name : "High neck dress", details : " " , price : "1600"},
                {img :   maria_dress ,     name :"maria dress" ,    details : " " , price : "1555"},
                {img :   midriff ,         name :'midriff' ,        details : "" ,  price : "1300"},
                {img :   One_shoulder_dresses, name :" One shoulder dresses", details : " " , price : "1800"},
                {img :   Puffed_sleeves ,      name :" Puffed sleeves" ,      details : " " , price : "1500" },
                {img :   white_dantiel ,       name :" white dantiel dress" , details : " " , price : "1200" }]
